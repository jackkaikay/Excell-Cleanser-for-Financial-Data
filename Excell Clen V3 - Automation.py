...
def sheetOne():
    ...
    sheet2a_added_info2 = [filename,filename,filename]
    ...
    sheet2b_added_info2 = [filename,filename,filename]
    ...
    sheet2d_added_info2 = [filename, filename, filename]
...
def sheetTwo():
    ...
    sheet2b_added_info2 = [filename,filename]
    ...
    sheet2d_added_info2 = [filename,filename,filename,filename,filename,filename,filename,filename]
...
def sheetThree():
    ...
    sheet2a_added_info2 = [filename, filename , filename , filename , filename, filename]
    ...
    sheet2d_added_info2 = [filename,filename,filename,filename]
    ...
    sheet2f_added_info2 = [filename, filename, filename, filename]
    ...
    sheet2h_added_info2 = [filename, filename, filename, filename, filename, filename, filename, filename]
    ...
    sheet2i_added_info2 = [filename, filename, filename, filename]
...
def sheetFive():
    ...
    sheet2a_added_info2 = [filename, filename , filename , filename ]
    ...
    sheet2c_added_info2 = [filename,filename,filename,filename,filename,filename]
    ...
    sheet2d_added_info2 = [filename,filename,filename,filename,filename,filename,filename,filename,filename,filename]
    ...
    sheet2g_added_info2 = [filename,filename,filename,filename,filename,filename]
    ...
    sheet2h_added_info2 = [filename,filename,filename]
    ...
    sheet2j_added_info2 = [filename,filename,filename,filename,filename]
...
def sheetSix():
    ...
    sheet2a_added_info2 = [filename, filename  ]
    ...
    sheet2f_added_info2 = [filename,filename,filename,filename,filename]
    ...
    sheet2g_added_info2 = [filename,filename]
...
def workbookTwo():
    ...
    sheet1.columns = ['Key','Month 1', 'Month 2','Month 3', 'Month 4', 'Month 5' ,'Month 6', 'Month 7', 'Month 8', 'Month 9', 'Month 10', 'Month 11', 'Month 12', 'Month 13', 'Month 14', 'Month 15', 'Month 16', 'Month 17', 'Month 18', 'Month 19', 'Month 20', 'Month 21', 'Month 22', 'Month 23', 'Month 24', 'Month 25', 'Month 26', 'Month 27', 'Month 272', 'Month 273']
    ...
    sheet1_added_info2 = [UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN, UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN,UKPRN]
    ...
    print(sheet1.to_string())
    sheet1.to_excel("M:\\2020\MiDES\\20M.058 Association of Colleges - Finance Projection Collection and Reporting\\6. Data Team\Data Outputs\Downloaded data\Monthly Cash Flows Outputs\\" + str(UKPRN) + "_" + filename,sheet_name='Monthly cash flow')

#########FinalExcelProductionArea#############
######### Financial Health Calculator #############
'''
for filename in os.listdir("M:\\2020\MiDES\\20M.058 Association of Colleges - Finance Projection Collection and Reporting\\6. Data Team\Data Outputs\Downloaded data\Financial Health Calculator"):
    workbook = ("M:\\2020\MiDES\\20M.058 Association of Colleges - Finance Projection Collection and Reporting\\6. Data Team\Data Outputs\Downloaded data\Financial Health Calculator\\" + filename)
    print(workbook)
    ukprnripper = pd.read_excel(workbook, sheet_name='Cover Sheet')


    UKPRN = ukprnripper.loc[14].values[8]


    print(workbook)

    writer = pd.ExcelWriter("M:\\2020\MiDES\\20M.058 Association of Colleges - Finance Projection Collection and Reporting\\6. Data Team\Data Outputs\Downloaded data\Financial Health Calculator Outputs\\" + str(UKPRN) + "_" + filename)
    ########WorkbookOne#############
    sheetOne()
    sheetTwo()
    sheetThree()
...
'''
'''
for filename in os.listdir("M:\\2020\MiDES\\20M.058 Association of Colleges - Finance Projection Collection and Reporting\\6. Data Team\Data Outputs\Downloaded data\Monthly Cash Flows"):
    workbook2 = ("M:\\2020\MiDES\\20M.058 Association of Colleges - Finance Projection Collection and Reporting\\6. Data Team\Data Outputs\Downloaded data\Monthly Cash Flows\\" + filename)
    print(workbook2)
    ukprnripper = pd.read_excel(workbook2, sheet_name='Monthly cash flow')

    UKPRN = ukprnripper.loc[2].values[0]
